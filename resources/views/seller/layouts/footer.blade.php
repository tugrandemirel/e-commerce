...
<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <script>document.write(new Date().getFullYear())</script> &copy; Tüm Hakları Saklıdır <a href="">Tuğran Demirel</a>
            </div>
            <div class="col-md-6">
...
{{--<script>
    (function() {
        ...
        const redirectUrl = '/test';  // Redirect idle users to this URL
